...
class Customer(Agent):
    ...
    def move_towards(self, destination):
        ...
        if not self.model.grid.out_of_bounds(new_position) and new_position not in self.model.boundaries:
...
class CanteenModel(Model):
    def __init__(self, width, height):
        ...
        self.entry_point = (43, random.randint(16, 18))
        ...
        self.dining_areas = [(3 * (i + 1), 14) for i in range(11)] + [(3 * (j + 1) + 1, 14) for j in range(11)] + \
                            ...
                            [(33, 2), (33, 3), (34, 2), (34, 3), (33, 19), (34, 19), (33, 20), (34, 20), (31, 19),
                             (30, 19), (31, 20), (30, 20)] + \
        ...
        self.boundaries = [(i, 0) for i in range(width)] + [(i, 23) for i in range(width)] + \
    ...
    def step(self):
        ...
        self.current_time += 1 / 120  # Assume one step is one minute
